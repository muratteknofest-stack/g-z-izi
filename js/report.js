...
const Report = {
    generate() {
      ...
      <div class="report-header">
        ...
        <p>Erken Tanı Asistanı • Göz Takibi Analiz Sonuçları</p>
      </div>
      ...
      <div class="report-footer">
        <p class="report-disclaimer">
          <strong>⚠️ Önemli Uyarı:</strong> Bu rapor, profesyonel bir tıbbi cihaz tarafından değil, 
          webcam tabanlı bir tarama aracı ile oluşturulmuştur. 
